...
if($_SERVER['REQUEST_METHOD'] == "POST"){ 
        ...
        try{
            if(isset($_POST['title']) && isset($_POST['des']) && isset($_POST['source']) && isset($_POST['img'])){
                ...
                $query = "INSERT INTO projects (`title`, `des`, `source`, `img`) VALUES ($title,$des,$source,$img)";
                $select = $db->query($query);
                if(!empty($select)){
                    header('Location:allpro.php');                
                } else {
                    $msg="Error Work";
                }
            }
...
<!-- Sidebar -->
      <div class="w3-sidebar w3-bar-block w3-card" style="display:none" id="mySidebar" style="width:190px;">
          ...
          <a href="#" class="w3-bar-item w3-button py-5"><i class="fa fa-plus-circle"></i> Add Projects</a>
