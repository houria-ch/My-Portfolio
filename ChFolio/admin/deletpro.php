...
$select = $db->query('SELECT * FROM `projects`');
...
<body>
    ...
    <div class="w3-sidebar w3-bar-block w3-card" style="display:none" id="mySidebar" style="width:190px;">
        ...
        <a href="#" class="w3-bar-item w3-button py-5"><i class="fa fa-trash"></i> Delete Projects</a>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="../img/portfolio/<?= $project['img'];?>" alt="<?= $project['title'];?>" width="200px"></td>
                            <td><a href="deletpro.php?id_project=<?=$project['id_project']; ?>"><i
