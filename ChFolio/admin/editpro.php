            ...
            <div class="w3-container" style="overflow-x:auto;">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row"><input class="input" name="id_project" disabled
                                    value="<?=$project['id_project']; ?>"></th>
                            <td><?= $project['title'];?></td>
                            <td><?= $project['des'];?></td>
                            <td><?= $project['source'];?></td>
                            <td><img src="../img/portfolio/<?= $project['img'];?>" width="200px" alt="<?= $project['title'];?>"></td>
                            <td><a href="editpage.php?id_project=<?= $project['id_project'];?>"><i
