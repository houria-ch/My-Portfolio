...
<head>
    ...
    <meta content="portfolio, houria, Web Developer, Web Designer, Frontend Developer , html , css , javascript"
        name="keywords">
    <meta
        content="Hello world!! I'm Houria Chafiq and I am a  Web Developer, Web Designer and Frontend Developer, welcome to my portfolio"
        name="description">
    <meta content="Houria CHAFIQ" name="author">
    <!-- Favicons -->
        ...
        <div class="intro-content display-table">
            <div class="table-cell">
                <div class="container">
                    ...
                    <a href="cv.html"><button type="button" id="cvbtn"
                            class="button button-a button-big button-rouded mt-5">Curriculum Vita</button></a>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row mt-5 pt-5">
                                    <div class="col-sm-6 col-md-5">
                                        <div class="about-img">
                                            <img src="img/about2.jpg" width="150" class="img-fluid rounded b-shadow-a"
                                                alt="Houria">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-7">
                                        <div class="about-info">
                                            ...
                                            <p><span class="title-s">Email: </span> <span>houriachafiq@gmail.com</span>
                                            </p>
                            ...
                            <div class="col-md-6">
                                <div class="about-me pt-4 pt-md-0">
                                    ...
                                    <p class="lead">
                                        My name is HOURIA CHAFIQ, I 'm 22 years old, I have a bachelor in low, and
                                        currently I 'm
                                        learner developer at YouCode. <br>
                                        So I'm learning web development and graphic design. Till now, I can create a
                                        frontend of site
                                        web with HTML, CSS, JavaScript and the framework Bootstrap. I can also create
                                        the graphic
                    ...
                    <div class="service-box">
                        ...
                        <div class="service-content">
                            ...
                            <div class="col-md-12 ml-5">
                                <a href="<?= $project['source'];?>"><button type="submit"
                                        class="button button-a button-big button-rouded">Go to source</button></a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="box-shadow-full">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div>
                                            <form action="contactform/contact.php" method="post" role="form"
                                                class="contactForm">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="more-info">
                                            <p class="lead">
                                                If you want to know more about me, this is my contact informations
                                                below.<br>
                                                Or You can send me a message from the formula on the left.
                                            </p>
                                            <ul class="list-ico">
                                                <li><span class="ion-ios-location"></span> Quartier SMARA Rue 35 N°3
                                                    Youssoufia</li>
                                        ...
                                        <div class="socials">
                                            <ul>
                                                <li><a href="https://www.facebook.com/profile.php?id=100005262966388"><span
                                                            class="ico-circle"><i
                                                                class="ion-social-facebook"></i></span></a></li>
                                                <li><a href="https://github.com/houria-ch"><span class="ico-circle"><i
                                                                class="ion-social-github"></i></span></a></li>
                                                <li><a href="https://twitter.com/search?q=houria-ch&src=typd&lang=fr"><span
                                                            class="ico-circle"><i
                                                                class="ion-social-twitter"></i></span></a></li>
                                                <li><a href="https://ma.linkedin.com/in/houria-chafiq-4646b5173"><span
                                                            class="ico-circle"><i
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="copyright-box">
                                ...
                                <div class="credits">
                                    Designed by <a href="https://bootstrapmade.com/">BootstrapMade <br> Modified by
                                        Houria</a>
                                </div>
                            </div>
                        </div>
